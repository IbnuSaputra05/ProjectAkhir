<div class="row" id="up">
    <div class="col mb-5">
        <?php if (isset($_SESSION["admin"])) : ?>
            <!-- navbar -->
            <nav class="navbar navbar-expand-lg navbar-dark bg-secondary fixed-top shadow p-3">
                <div class="container">
                    <a class="navbar-brand" href="index.php">Lowongan.ID</a>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-secondary fixed-top shadow p-3">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="btn btn-success mr-1" href="registrasi.php">Registrasi</a>
                            </li>
                            <li class="nav-item">
