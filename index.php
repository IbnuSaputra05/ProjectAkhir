    ...
    <?php if (isset($_SESSION["admin"])) : ?>
        ...
        <div class="jumbotron jumbotron-fluid bg jumbotron-index">
            <div class="container text-center">
                <h1 class="display-1">Lowongan.ID</h1>
                <p class="lead">Cari Pekerjaan Sesuai Keahlian dan Lokasi Anda.</p>

                <div class="row text-center mb-3">
                    <div class="col-md-3 offset-md-3">
                        <a href="profil.php"><button type="button" class="btn btn-secondary btn-block font-weight-bold">Profil Admin</button></a>
                    </div>
                    <div class="col-md-3">
                        <a href="dashboard.php"><button type="button" class="btn btn-secondary btn-block font-weight-bold">Dashboard Admin</button></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php elseif (isset($_SESSION["perusahaan"])) : ?>
        ...
        <div class="jumbotron jumbotron-fluid bg jumbotron-index">
            <div class="container text-center">
                ...
                <div class="row text-center mb-3">
                    <div class="col-md-3 offset-md-3">
                        <a href="profil.php"><button type="button" class="btn btn-secondary btn-block font-weight-bold">Profil Saya</button></a>
                    </div>
                    <div class="col-md-3">
                        <a href="buat-loker.php"><button type="button" class="btn btn-secondary btn-block font-weight-bold">Buat Loker</button></a>
                    </div>
                </div>
                <div class="row text-center">
                    <div class="col-md-3 offset-md-3">
                        <a href="data-loker.php">
                            <button type="button" class="btn btn-secondary btn-block font-weight-bold">
                                Kelola Loker
                            </button>
                        </a>
                    </div>
        ...
        <div class="jumbotron jumbotron-fluid bg jumbotron-index">
            <div class="container text-center">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-3">
                        <a href="cari-loker.php"><button type="button" class="btn btn-secondary btn-block font-weight-bold">Cari Loker Lanjutan</button></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container text-center">
                ...
                <div class="row center">
                    <div class="col text-center">
                        <a href="registrasi.php" type="button" class="btn btn-secondary align-content-center">Daftar Sekarang</a>
                    </div>
                </div>
            </div>
        </div>
